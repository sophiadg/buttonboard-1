...
<div class="main" id="debrief">
	...
	<form name='frm' action='theend.php' method='post' onsubmit='return validateForm()'>
		<br>
		<br>
		Please tell us some of the things you were trying to do:<br>
...
<script>
	var uid = "<?php global $UID;
				echo $UID; ?>";

	// function loadEventHandler() {
	//    var valid =  <?php global $validrequest;
						echo $validrequest; ?>;
	//    if (!valid) {
